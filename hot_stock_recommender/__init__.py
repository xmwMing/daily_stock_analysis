    ...
    def run(self) -> str:
        ...
        try:
            ...
            if not hot_stocks:
                ...
                return RecommendationReport.generate([], finder_stats=self.finder.stats)
            ...
            # 传递 finder 的统计信息
            report = RecommendationReport.generate(recommendations, finder_stats=self.finder.stats)
