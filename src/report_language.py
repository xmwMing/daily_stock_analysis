...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "chip_label": "筹码",
        "chip_profit_ratio_label": "获利比例",
        "chip_avg_cost_label": "平均成本",
        "chip_concentration_label": "集中度",
        "chip_health_label": "健康度",
        "chip_concentration_hint": "集中度通常越低越集中（约 <15% 更集中）",
    ...
    "en": {
        ...
        "chip_profit_ratio_label": "Profit Ratio",
        "chip_avg_cost_label": "Avg Cost",
        "chip_concentration_label": "Concentration",
        "chip_health_label": "Health",
        "chip_concentration_hint": "Lower concentration usually means chips are more concentrated (around <15% is tighter)",
